...
=== BAND ROUNDING RULES ===
Average the four criteria scores. If average ends in .25 round DOWN. If .75 round UP.
...
- Band 7 CC requires genuinely varied cohesive devices — over-use of Furthermore/Moreover/Additionally caps at 6.5.
...
=== WORD COUNT RULES ===
Task 1 < 150 words: TA capped at Band 5.
Task 2 < 250 words: TR capped at Band 5.
...
Return ONLY this exact JSON, no markdown, no preamble:
{
  ...
  "vocabularyHighlights": {
    "effective": ["string"],
    "problematic": ["string — explanation"]
  },
  "errorAnnotations": [
    { "quote": "string", "type": "Grammar|Vocabulary|Spelling|Punctuation", "issue": "string", "correction": "string" }
  ],
